...
const std::vector<glm::vec3> cube = {
    glm::vec3(1.0, 1.0, -1.0),   glm::vec3(1.0, 0.0, 0.0),   glm::vec3(-1.0, 1.0, -1.0),
    glm::vec3(1.0, 0.0, 0.0),    glm::vec3(1.0, 1.0, 1.0),   glm::vec3(1.0, 0.0, 0.0),
    glm::vec3(-1.0, 1.0, 1.0),   glm::vec3(0.0, 1.0, 0.0),   glm::vec3(-1.0, -1.0, 1.0),
    glm::vec3(0.0, 1.0, 0.0),    glm::vec3(-1.0, 1.0, -1.0), glm::vec3(0.0, 1.0, 0.0),
    glm::vec3(-1.0, -1.0, -1.0), glm::vec3(0.0, 0.0, 1.0),   glm::vec3(1.0, 1.0, -1.0),
    glm::vec3(0.0, 0.0, 1.0),    glm::vec3(1.0, -1.0, -1.0), glm::vec3(0.0, 0.0, 1.0),
    glm::vec3(1.0, 1.0, 1.0),    glm::vec3(1.0, 1.0, 0.0),   glm::vec3(1.0, -1.0, 1.0),
    glm::vec3(1.0, 1.0, 0.0),    glm::vec3(-1.0, -1.0, 1.0), glm::vec3(1.0, 1.0, 0.0),
    glm::vec3(1.0, -1.0, -1.0),  glm::vec3(1.0, 0.0, 1.0),   glm::vec3(-1.0, -1.0, -1.0),
...
int main(int argc, const char **argv)
{
    ...
    for (int i = 1; i < argc; ++i) {
        if (std::strcmp(argv[i], "-eye") == 0) {
            ...
            std::cout << "Usage: " << argv[0] << " (-eye x y z) (-center x y z) (-up x y z)\n";
            return 0;
        }
    }
